...
export default function HeroFullscreen() {
  return (
    <section className="relative w-full h-[100svh] bg-white overflow-hidden">
      ...
      {/* テキストブロック：画面左下配置 */}
      <div className="absolute bottom-8 left-6 px-4">
        <div className="max-w-xl md:max-w-2xl rounded-2xl bg-black/45 backdrop-blur-sm p-6 md:p-8 text-white shadow-lg">
